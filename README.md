...
Fetch web page using libcurl

Add new URLs (based on depth control)
...
🎓 Conclusion
This project successfully demonstrates how operating system concepts can be applied to build a safe, efficient, and scalable multi-threaded system. It highlights the importance of synchronization and controlled concurrency in real-world applications like web crawling.
